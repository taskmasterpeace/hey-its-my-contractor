...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const formattedResults = data.items?.map((item: { link: string; image: { thumbnailLink: string; contextLink?: string }; title: string; displayLink: string; snippet?: string }, index: number) => {
