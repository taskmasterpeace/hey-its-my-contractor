  ...
  try {
    ...
    const mockResults = [
      ...
      },
      {
        ...
        url:
          "https://via.placeholder.com/550x350/FF6900/FFFFFF?text=HD+Builder+" +
          encodeURIComponent(query),
        thumbnail:
          "https://via.placeholder.com/275x175/FF6900/FFFFFF?text=HD+BC",
        source: "Home Depot",
        retailer: "homedepot",
      ...
      },
      {
        ...
        url:
          "https://via.placeholder.com/650x450/004990/FFFFFF?text=Lowes+Signature+" +
          encodeURIComponent(query),
        thumbnail:
          "https://via.placeholder.com/325x225/004990/FFFFFF?text=LW+SIG",
        source: "Lowe's",
        retailer: "lowes",
