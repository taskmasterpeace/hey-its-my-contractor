...
interface MagicWandModalProps {
  ...
  onGenerate: (sourceImage: any, referenceImage: LibraryImage | null, prompt: string) => void;
}
...
export function MagicWandModal({ 
  ...
  const [selectedReference, setSelectedReference] = useState<LibraryImage | null>(null);
    ...
    try {
      ...
      const response = await fetch('/api/replicate/generate', {
        ...
        body: JSON.stringify({
          ...
          prompt,
          sourceImage: sourceImage.url || sourceImage.thumbnail, // Send the source image (handle both search results and library images)
      ...
      <div className="bg-white rounded-lg max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">AI Image Enhancement</h2>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              {/* Source Image */}
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Source Image</h3>
                <div className="relative bg-gray-100 rounded-lg p-4">
                  ...
                  />
                  <div className="mt-3">
                    <h4 className="font-medium text-gray-900">{sourceImage.title}</h4>
                    {sourceImage.source && (
                      <p className="text-sm text-gray-600">From: {sourceImage.source}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  <option value="all">All Library Images ({libraryImages.length})</option>
                  ...
                  <div className="mb-3 p-3 bg-gray-50 rounded-lg">
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={() => {
                          if (newPreset.trim()) {
                            setCustomPresets(prev => [...prev, newPreset.trim()]);
                            setNewPreset('');
                  ...
                  {allPresets.map((preset, index) => (
                    <div key={preset} className="relative group">
                      ...
                      {index >= defaultPresets.length && (
                        <button
                          onClick={() => setCustomPresets(prev => prev.filter((_, i) => i !== (index - defaultPresets.length)))}
            ...
            {/* Right Column - Result */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">AI Generated Result</h3>
              ...
              {generatedResult ? (
                ...
                <div className="h-64 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p className="text-xs">Select reference and enter prompt above</p>
                  </div>
                </div>
              )}
            </div>
