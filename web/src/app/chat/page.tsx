    ...
    setTimeout(() => {
      const sampleMessages: ChatMessage[] = [
        ...
        },
        {
          ...
          channel_id: room.id,
          user_id: 'contractor-1',
          content: 'Demo work is complete. Here\'s a photo of the space ready for electrical.',
          type: 'text',
          attachments: [{
            id: 'att-1',
            type: 'image',
        ...
        },
        {
          ...
          channel_id: room.id,
          user_id: 'contractor-1',
          content: 'Perfect! Just finished the electrical rough-in. Ready for inspection.',
          type: 'text',
